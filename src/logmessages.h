...
static const char modeAudioFeedback[] PROGMEM = "Modus: Audio Feedback";
...
static const char modificatorAllButtonsLockedBaby[] PROGMEM = "Modifikator: Alle Tasten werden per RFID gesperrt (Babymodus).";
static const char modificatorAllButtonsUnlockedBaby[] PROGMEM = "Modifikator: Alle Tasten werden per RFID freigegeben (Babymodus).";
...
static const char playingfilenow[] PROGMEM = "Playing file now..";
